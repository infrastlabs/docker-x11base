...
core-debian `8` | ![pic](https://img.shields.io/docker/image-size/library/debian/8-slim) | ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/core-debian-8)|-| ★★★★☆
core-debian `10` | ![pic](https://img.shields.io/docker/image-size/library/debian/10-slim) | ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/core-debian-10)|-| ★★★★☆
core-debian `11` | ![pic](https://img.shields.io/docker/image-size/library/debian/11-slim) | ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/core-debian-11)|-| ★★★★★
core-debian `12` | ![pic](https://img.shields.io/docker/image-size/library/debian/12-slim) | ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/core-debian-12)|-| ★★★★★
core-debian `13` | ![pic](https://img.shields.io/docker/image-size/library/debian/13-slim) | ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/core-debian-13)|-| ★★★★★
...
core-openeuler `22.03-lts-sp4` | ![pic](https://img.shields.io/docker/image-size/openeuler/openeuler/22.03-lts-sp4) | ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/core-openeuler-22.03-lts-sp4)|-| ★★★★☆(-armv7)
core-voidlinux `latest.v2509` | ![pic](https://img.shields.io/docker/image-size/voidlinux/voidlinux/latest) | ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/core-voidlinux-v2509)|-| ★★★★☆
---  | ---  | --- | --- | --- 
...
core-alpine-3.3 | ![pic](https://img.shields.io/docker/image-size/library/alpine/3.3) | ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/core-alpine-3.3)| ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/app-alpine-3.3)|★★★★☆(-armv7)
core-alpine-3.4 | ![pic](https://img.shields.io/docker/image-size/library/alpine/3.4) | ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/core-alpine-3.4)| ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/app-alpine-3.4)|★★★☆☆(-armv7,firefox)
core-alpine-3.5 | ![pic](https://img.shields.io/docker/image-size/library/alpine/3.5) | ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/core-alpine-3.5)| ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/app-alpine-3.5)|★★★☆☆(-armv7,firefox)
core-alpine-3.6 | ![pic](https://img.shields.io/docker/image-size/library/alpine/3.6) | ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/core-alpine-3.6)| ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/app-alpine-3.6)|★★★★☆(-firefox)
...
core-alpine-3.10 | ![pic](https://img.shields.io/docker/image-size/library/alpine/3.10) | ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/core-alpine-3.10)| ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/app-alpine-3.10)|★★★★☆(-firefox)
core-alpine-3.11 | ![pic](https://img.shields.io/docker/image-size/library/alpine/3.11) | ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/core-alpine-3.11)| ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/app-alpine-3.11)|★★★★☆(-firefox)
core-alpine-3.12 | ![pic](https://img.shields.io/docker/image-size/library/alpine/3.12) | ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/core-alpine-3.12)| ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/app-alpine-3.12)|★★★★★
...
core-alpine-3.14 | ![pic](https://img.shields.io/docker/image-size/library/alpine/3.14) | ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/core-alpine-3.14)| ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/app-alpine-3.14)|★★★★★
...
core-ubuntu-22.04 | ![pic](https://img.shields.io/docker/image-size/library/ubuntu/22.04) | ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/core-ubuntu-22.04)| ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/app-ubuntu-22.04)|★★★★★(-firefox)
core-ubuntu-24.04 | ![pic](https://img.shields.io/docker/image-size/library/ubuntu/24.04) | ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/core-ubuntu-24.04)| ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/app-ubuntu-24.04)|★★★★★(-firefox)
...
core-opensuse-15.1 | ![pic](https://img.shields.io/docker/image-size/opensuse/leap/15.1) | ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/core-opensuse-15.1)| ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/app-opensuse-15.1)|★★★★★
core-opensuse-15.2 | ![pic](https://img.shields.io/docker/image-size/opensuse/leap/15.2) | ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/core-opensuse-15.2)| ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/app-opensuse-15.2)|★★★★★
core-opensuse-15.3 | ![pic](https://img.shields.io/docker/image-size/opensuse/leap/15.3) | ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/core-opensuse-15.3)| ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/app-opensuse-15.3)|★★★★★
core-opensuse-15.4 | ![pic](https://img.shields.io/docker/image-size/opensuse/leap/15.4) | ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/core-opensuse-15.4)| ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/app-opensuse-15.4)|★★★★★
...
core-opensuse-15.6 | ![pic](https://img.shields.io/docker/image-size/opensuse/leap/15.6) | ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/core-opensuse-15.6)| ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/app-opensuse-15.6)|★★★★☆(-armv7)
...
- ~~pulseaudio~~ https://github.com/pulseaudio/pulseaudio/graphs/contributors `Jun 6, 2004+`
  ...
  - pasystray https://github.com/christophgysin/pasystray/graphs/contributors `2011年10月2日+; c`
  - pnmixer https://github.com/nicklan/pnmixer/graphs/contributors `2011年5月8日+; c`
- [**wm**]
...
- gpicview/ristretto https://github.com/lxde/gpicview/graphs/contributors `Sep 9, 2007`
  - feh https://github.com/derf/feh/graphs/contributors `2010年1月31日+`
...
- pac/asbru-cm https://github.com/asbru-cm/asbru-cm/graphs/contributors `2011年2月27日+; perl`
...
- scrot https://github.com/resurrecting-open-source-projects/scrot/graphs/contributors `2019年2月10日+; c`
  ...
  - flameshot https://github.com/flameshot-org/flameshot/graphs/contributors `2017年5月7日+; cpp,qt`
