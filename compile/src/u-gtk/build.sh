...
# gh=https://ghps.cc/
# https://gitee.com/g-system/fk-suckless-gtk #git clone;
GTK_VER=0.8.4
GTK_URL=${gh}https://github.com/neutrinolabs/xrdp/releases/download/v${XRDP_VER}/xrdp-${XRDP_VER}.tar.gz
...
*) #compile
    ...
    set +e
    echo -e "\n$1, start building.."
    begin_time="`gawk 'BEGIN{print systime()}'`"; export logfile=$LOGS/gtk-$1.log
