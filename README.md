...
ubt2004  |Ubuntu| 20.04 | amd64,arm64,armv7 | perp/sv | [![Docker Image Size](https://img.shields.io/docker/image-size/infrastlabs/x11-base/fluxbox)](https://hub.docker.com/r/infrastlabs/x11-base/tags)|★★★★★
alma86   |AlmaLinux| 8.6 | amd64,arm64 | perp/sv | [![Docker Image Size](https://img.shields.io/docker/image-size/infrastlabs/x11-base/alma)](https://hub.docker.com/r/infrastlabs/x11-base/tags)|★★★★☆
---|---|---|---|---|---|---
compile |Alpine| 3.15 | amd64,arm64,armv7  | perp/sv | [![Docker Image Size](https://img.shields.io/docker/image-size/infrastlabs/x11-base/alpine-compile)](https://hub.docker.com/r/infrastlabs/x11-base/tags)|★★★★★
