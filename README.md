...
dist=openeuler;dcp pull $dist; dcp up -d $dist
dist=voidlinux;dcp pull $dist; dcp up -d $dist
```
...
core-voidlinux `v2509` | ![pic](https://img.shields.io/docker/image-size/voidlinux/voidlinux/latest) | ![pic](https://img.shields.io/docker/image-size/infrastlabs/x11-base/core-voidlinux-v2509)|-| ★★★★☆
